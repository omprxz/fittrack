...
function New() {
  ...
  const api_baseurl = process.env.REACT_APP_API_URL
    ...
    try {
        ...
        const response = await axios.post(api_baseurl+"/api/log", formData, {
            headers: {
    ...
    return (
        <div className="container mx-auto px-4 bg-gray-900 pt-5">
        <h1 className="text-center mb-3 font-bold text-2xl text-white">New Log</h1>
...
<div className="flex items-center justify-center w-full mt-5">
    <label for="dropzone-file" className="flex flex-col items-center justify-center w-80 h-44 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-800 hover:bg-gray-700">
